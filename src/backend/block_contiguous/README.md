...
2. Vectorised loads: `{blocked/non_blocked}_gemm_vec.cu`
3. 1D Tiling: `{blocked/non_blocked}_gemm_vec_1d.cu`
4. 2D Tiling: `{blocked/non_blocked}_gemm_vec_2d.cu`
5. Warp tiling: `{blocked/non_blocked}_gemm_vec_warp.cu`
6. Double Buffering: `blocked_gemm_vec_double_buf.cu, non_blocked_gemm_vec_double_buf_async.cu, non_blocked_gemm_vec_double_buf_sync.cu`
