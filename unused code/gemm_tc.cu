...
// #define MEM_TILE_M 128
// #define MEM_TILE_K 128
// #define MEM_TILE_N 128
...
// 1. Matrix A: Standard Row-Major
// Memory Layout: Row 0, then Row 1, ...
// Index = Row * Stride + Col
#define GET_A_INDEX_GENERAL(row, col) \
    ( (size_t)(row) * K_GLOBAL + (size_t)(col) )

// 2. Matrix B: Standard Column-Major
// Memory Layout: Col 0, then Col 1, ...
// Index = Col * Stride + Row
// Note: In B, 'row' is the K dimension, 'col' is the N dimension.
#define GET_B_INDEX_GENERAL(row_k, col_n) \
    ( (size_t)(col_n) * K_GLOBAL + (size_t)(row_k) )
